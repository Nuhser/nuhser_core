#
# Desc.: Checks for triggered help requests and gives output in chat.
...
#write info message
tellraw @a[scores={help=1}] [{"text":"Nuhser Core Manual","underlined":true,"color":"dark_aqua"},{"text":" (v3.0.4)","underlined":false}]
