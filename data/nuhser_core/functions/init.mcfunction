...
tellraw @a ["",{"text":"Start initialization...","color":"dark_purple"}]
tellraw @a ["",{"text":"Creating tracking-scoreboards for sneaking and carrot_on_a_stick...","color":"yellow"}]
...
tellraw @a ["",{"text":"Creating trigger for help-functions...","color":"yellow"}]

scoreboard objectives add help trigger

#create RNG scoreboard
tellraw @a ["",{"text":"Setting up rng...","color":"yellow"}]
...
tellraw @a ["",{"text":"Setting up the Unique-Nuhser-ID system...","color":"yellow"}]

scoreboard objectives add nuhser_id dummy
scoreboard players add $counter nuhser_id 0

#create constants
tellraw @a ["",{"text":"Saving nuhser_constants...","color":"yellow"}]
...
#set gamerules
tellraw @a ["",{"text":"Changing gamerules for commandBlockOutput, disableElytraMovementCheck and spawnRadius...","color":"yellow"}]
...
tellraw @a ["",{"text":"Initializing additional counters...","color":"yellow"}]

function nuhser_core:initialize_counters

tellraw @a ["",{"text":"Nuhser Core successful initialized!","color":"green"}]

#schedule nuhser_core:second to run in one second
schedule function nuhser_core:second 1s

tellraw @a ["",{"text":"Scheduled #nuhser_core:second to run once every second!","color":"green"}]

#initialize all other nuhser mods
tellraw @a ["",{"text":"Initializing all other nuhser mods...","color":"dark_purple"}]

function #nuhser_core:init

#end message
tellraw @a ["",{"text":"Initialization successful!","color":"dark_purple"}]
